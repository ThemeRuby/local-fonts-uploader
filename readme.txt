...
## Documentation
Access the plugin documentation for usage instructions: [Documentation](https://docs.themeruby.com/local-fonts-uploader/)
...
7. Read the [Documentation](https://docs.themeruby.com/local-fonts-uploader/) to get started.
